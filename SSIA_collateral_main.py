...
from SSIA_collateral_task_allocation import SequentialSingleItemAuctioneer
...
def run_simulation(
    ...
    print("=" * 60)
    print("  SSIA-Cost Exploration Simulation")
    print("  allocator=SequentialSingleItemAuctioneer (with collateral)")
